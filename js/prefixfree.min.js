...
(function() {
    ...
    if (window.addEventListener) {
        var b = window.StyleFix = {
            link: function(a) {
                try { if ("stylesheet" !== a.rel || a.hasAttribute("data-noprefix")) return } catch (c) { return }
                    ...
                    if (4 === e.readyState) {
                        ...
                        if (c && a.parentNode) {
                            ...
                            f && (c = c.replace(/url\(('?|"?)(.+?)\1\)/gi,
                                function(a, c, b) { return !/^([a-z]{3,10}:|\/|#)/i.test(b) ? 'url("' + f + b + '")' : a }), c = c.replace(RegExp("\\b(behavior:\\s*?url\\('?\"?)" + f, "gi"), "$1"));
            ...
            fix: function(a, c) { for (var d = 0; d < b.fixers.length; d++) a = b.fixers[d](a, c) || a; return a },
        ...
        (function() {
            setTimeout(function() { h('link[rel="stylesheet"]').forEach(StyleFix.link) }, 10);
...
(function(h) {
    if (window.StyleFix && window.getComputedStyle) {
        var b = window.PrefixFree = {
            ...
            prefixSelector: function(a) { return a.replace(/^:{1,2}/, function(a) { return a + b.prefix }) },
            prefixProperty: function(a, c) { var d = b.prefix + a; return c ? StyleFix.camelCase(d) : d }
        };
        (function() {
            var a = {},
                c = [],
        ...
        (function() {
            function a(a) { f.textContent = a + "{}"; return !!f.sheet.cssRules.length }
            ...
            var f = h.appendChild(document.createElement("style")),
                g;
            for (g in c) { var e = g + (c[g] ? "(" + c[g] + ")" : "");!a(e) && a(b.prefixSelector(e)) && b.selectors.push(g) }
